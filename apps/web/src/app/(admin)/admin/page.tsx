		...
		<main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col px-6 py-16">
			...
			<section aria-label="Admin tools" className="grid gap-4 sm:grid-cols-2">
				...
				<a
					...
					className="group border border-border p-5 transition hover:border-primary focus:outline-none focus:ring-2 focus:ring-primary"
				>
					<p className="text-sm font-medium text-muted">Diagnostics</p>
					<h2 className="mt-3 text-xl font-semibold text-foreground">
						Error testing
					</h2>
					<p className="mt-3 text-sm leading-6 text-subtle">
						Trigger client and server errors to verify Sentry and PostHog error
						reporting.
					</p>
					<p className="mt-5 text-sm font-medium text-primary">
						Open error tests <span aria-hidden="true">-&gt;</span>
					</p>
				</a>
